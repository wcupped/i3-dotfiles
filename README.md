# i3 dotfiles by wCupped
it's just a little bit setupped i3 and etc. configs.
...
(you will need to build boomer yourself, or install it from AUR, for debian you will need to install iosevka font also manually)

# Installation:
just exec install.sh file, that's it
```
bash ./install.sh
```
